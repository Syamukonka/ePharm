defmodule EPharmWeb.Router do
  use EPharmWeb, :router
  ...
  # scope "/api", EPharmWeb do
  #   pipe_through :api
  # end

  # Enable LiveDashboard and Swoosh mailbox preview in development
  if Application.compile_env(:ePharm, :dev_routes) do
    ...
    scope "/dev" do
      ...
      live_dashboard "/dashboard", metrics: EPharmWeb.Telemetry
